...
设计模式本身是一种规范与技巧，其存在的目的主要是拓展或者弥补面向对象语言在编程开发上的补足。设计模式可以把一些语言无法更好解决的问题交给开发者来处理，就像C++没有垃圾回收机制，但是Java提供了，Java没有线程管理机制但是Scala提供了。我们可以通过以下两个例子来对比说明设计模式是如何弥补语言设计上的缺陷的，或者说更优秀的语言为何是不需要某些设计模式的。